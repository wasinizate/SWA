...
const { registerContentItemIpc } = require('./ipc/contentItemIpc');
const { registerContentScanIpc } = require('./ipc/contentScanIpc');
const { registerAnalyticsIpc } = require('./ipc/analyticsIpc');
...
app.whenReady().then(() => {
  ...
  registerContentItemIpc();
  registerContentScanIpc();
