...
export function renderPeopleView(container, { navigate }) {
  container.innerHTML = `
    ...
    <table class="data-table">
      <thead><tr><th>Label</th><th>Tags</th><th>Added</th><th></th></tr></thead>
      <tbody id="rows"><tr><td colspan="4" class="loading-state">Loading…</td></tr></tbody>
    </table>
  `;
  ...
  async function refresh() {
    const [people, groupedTags, allTags] = await Promise.all([
